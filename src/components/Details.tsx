...
const CountdownTimer: React.FC = () => {
  ...
  useEffect(() => {
    // Wedding date: 8 Feb 2026
    const weddingDate = new Date('2026-02-08T19:00:00').getTime();
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="font-body text-gray-700 leading-relaxed mb-4">
            <span className="font-heading text-xl">Mr. & Mrs. Arya</span>
          </p>
          <p className="font-body text-gray-700 leading-relaxed mb-4">
            request the honor of your presence at the marriage of their daughter
          </p>
          <h2 className="text-4xl font-display my-3 text-primary">Isha Arya</h2>
          <p className="font-body text-gray-700 leading-relaxed mb-4">to</p>
          <h2 className="text-4xl font-display my-3 text-primary">Khushal Nachan</h2>
          <p className="font-body text-gray-700 leading-relaxed mb-4">
            <span className="font-heading text-xl">son of Mr. & Mrs. Nachan</span>
          </p>
